...
//     assert_eq!(root_list.files[0].path, "/a.txt");
//     assert_eq!(root_list.files[1].path, "/b.txt");
...
//     assert_eq!(c_list.files[0].path, "/c/d.txt");
//     assert_eq!(c_list.files[1].path, "/c/e.txt");
//
...
//     assert_eq!(g_list.files[0].path, "/f/g/h.txt");
//
